...
$config = [
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 'jRcse61N0omzFEYTLOwng0dbK7miRMa9',
        ],
        'cache' => [
        ...
        'db' => $db,
        'urlManager' => [
            'enablePrettyUrl' => true, // включает красивых URL
            'showScriptName' => false, // убирает index.php из URL
            'enableStrictParsing' => false, // разрешаем любые URL, соответствующие правилам
            'rules' => [
